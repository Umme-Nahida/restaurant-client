...
const ShareMenu = ({item}) => {
    ...
    return (
        <div className="flex items-start lg:items-center space-x-5">
            <img src={item?.image ? item?.image : 'https://i.ibb.co.com/tX4Gbcp/Rectangle1.png'} alt="" style={{borderRadius:"0 200px 200px 200px" }} className="w-[100px] duration-300 hover:scale-110" />
            <div>
